...
export type Expr = BinaryExpr | UnaryExpr | PropertyRef | NumberLiteral | StringLiteral | IdentRef;
...
export type Statement = TypeDecl | EnumDecl | EntityDecl | DerivedEntityDecl | MapDecl;
