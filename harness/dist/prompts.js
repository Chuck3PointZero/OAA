...
export const promptDefinitions = [
    {
        name: "oaa_bootstrap",
        description: "Bootstrap a new OAA workspace. Creates the initial directory structure, a CLAUDE.md wrapper entry point, and a starter agent with one role.",
        arguments: [
            {
                name: "agentName",
    ...
    },
    {
        ...
        description: "Create a new OAA node (agent, role, skill, or tool) with correct frontmatter. Guides you through placement and wiring.",
        arguments: [
            {
                name: "kind",
    ...
    },
    {
        ...
        description: "Author the authority section for a role or tool. Guides you through decides/escalates/never placement following the composition algebra.",
        arguments: [
            {
                name: "nodeName",
    ...
    {
        name: "oaa_decompose",
        description: "Decompose an existing role or agent into smaller roles and shared skills. Use when a role is doing too much.",
        arguments: [
            {
                name: "nodeName",
    ...
    {
        name: "oaa_compile",
        description: "Compile a named agent: walk AGENT.md → ROLE(s) → SKILL(s) → TOOL(s), compose authority algebra, write AGENTS.md, and update agents.lock.",
        arguments: [
            {
                name: "agentName",
    ...
    {
        name: "oaa_validate",
        description: "Validate the OAA graph for the current workspace. Check node identities, edge resolution, authority conflicts, lockfile integrity.",
        arguments: [],
    },
];
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export function getPromptContent(promptName, args) {
    switch (promptName) {
        case "oaa_bootstrap":
...
function createNodePrompt(args) {
...
function authorAuthorityPrompt(args) {
