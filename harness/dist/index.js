...
const { version: HARNESS_VERSION } = _req("../package.json");
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    return handleTool(name, (args ?? {}), ROOT_DIR);
});
// ---------------------------------------------------------------------------
// Resources
// ---------------------------------------------------------------------------
...
server.setRequestHandler(GetPromptRequestSchema, async (request) => {
    ...
    return {
        description: promptDefinitions.find((p) => p.name === name)?.description ?? name,
        messages: [message],
    };
});
// ---------------------------------------------------------------------------
...
async function main() {
    ...
    process.stderr.write(`@oaa/harness running. Root: ${ROOT_DIR}\n`);
}
main().catch((err) => {
